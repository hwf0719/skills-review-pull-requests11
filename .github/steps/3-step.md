...
1. Enter the following comment and click the **Submit review** button.
   ...
   <img width="300" alt="Submit review button" src="https://github.com/hwf0719/skills-review-pull-requests11/blob/main/.github/images/submit-review-button.png?raw=true" />
